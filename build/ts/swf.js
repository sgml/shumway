            ...
            function defineImage(tag) {
                ...
                if (tag.mimeType === 'image/jpeg') {
                    ...
                    if (alphaData) {
                        ...
                        release || assert(image.width === jpegImage.width && image.height === jpegImage.height, 'Wrong image size after parsing: ' + image.width + 'x' + image.height + ' vs ' + jpegImage.width + 'x' + jpegImage.height);
